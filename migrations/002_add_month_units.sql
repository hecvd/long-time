-- Add 'months' to the allowed milestone duration units. SQLite cannot alter a
-- CHECK constraint in place, so the entries table is rebuilt.
...
INSERT INTO entries SELECT * FROM entries_without_months;
